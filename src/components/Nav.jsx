// TODO: create GlobalSvgSelector and export icons from it
import Logo from "../assets/images/logo.svg";
import Seach from "../assets/images/search.svg";
    ...
    <nav className="nav-wrapper">
      <div className="nav-content">
        <ul className="list-styled">
          ...
          {/* TODO: moved list content to data file and render items through map finction */}
          <li>
